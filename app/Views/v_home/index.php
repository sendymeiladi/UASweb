...
<section id="hero" class="d-flex align-items-center">
  <div class="container" data-aos="zoom-out" data-aos-delay="100">
    <h1>PMB <span>STMIK Mardira Indonesia</spa>
    </h1>
    <h2>Aplikasi Pendaftaran Mahasiswa Baru - STMIK Mardira Indonesia</h2>
    <div class="d-flex">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="description">Pendaftaran dapat dilakukan mulai dari tanggal <b><?= tgl_indonesia($tanggal['tgl_buka']); ?></b> sampai dengan tanggal <b><?= tgl_indonesia($tanggal['tgl_tutup']); ?></b> melalui Aplikasi PMB STMIK Mardira Indonesia</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="description">Pengumuman lulus administrasi dapat dilihat pada tanggal <b><?= tgl_indonesia($tanggal['tgl_pengumuman']); ?></b> dengan cara login menggunakan akun pendaftaran Aplikasi PMB STMIK Mardira Indonesia</p>
          </div>
        </div>
      </div>
  ...
  <section id="team" class="faq section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        ...
        <p>Penerimaan Mahasiswa Baru STMIK Mardira Indonesia diselenggarakan dengan prinsip adil dan tidak diskriminatif.</p>
      </div>
